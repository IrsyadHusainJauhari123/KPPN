                ...
                <div class="container text-white py-2">
                    <div class="d-flex align-items-center">
                        <div class="mr-3">
                            ...
                            <h5 class="op-7 mb-3">Monitoring data</h5>
                        </div>
                        <div class="ml-auto">
            ...
            <div class="container mt--5">
                            ...
                            <form action="{{ url('depan') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group form-inline mt--1">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="bulan" class="form-control date-picker-bulan"
                                        ...
                                        <select name="kode_akun" class="form-control" id="validationDefault01">
                ...
                <div class="row mb-4 data">
                    ...
                    <div class="col-md-6 mt-5">
                        ...
                        <div class="chart-container">
                            <canvas id="lineChart6" style="width: 50%; height: 50%"></canvas>
                        </div>
                    </div>
                    <div class="col-md-6 mt-5">
                        <span>Monitoring Data</span>
