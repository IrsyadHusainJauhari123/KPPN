                        ...
                        <div class="modal fade" id="basicModal">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <form action="{{ url('kodeakun') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <label for="kode_akun" class="control-label">Kode</label>
                            ...
                            <table id="add-row" class="display table table-striped table-hover">
                                ...
                                <tbody>
                                    @foreach ($list_kodeakun as $kodeakun)
                                        ...
                                        {{-- <td>{{ $kodeakun->email }}</td> --}}

                                        <td>
                                            {{-- <div class="btn-group">

                                                    <button class="btn btn-warning" data-toggle="modal"
                                                        data-target="#edit{{ $kodeakun->id }}">
                                                        <i class="fa fa-edit"></i>
                                                    </button>
                                                    @include('components.utils.delete', [
                                                        'url' => url('kodeakun', $kodeakun->id),
                                                    ])
                                                </div> --}}
                                            ...
                                            <div class="form-button-action">
                                                ...
                                                {{-- <a href="{{ url('kodeakun', $kodeakun->kodeakun) }}" class="btn btn"
                                                            style="background: rgb(13, 186, 195)">
                                                            <i class="fa fa-info" style="color: black"></i>
                                                        </a> --}}

                                                @include('components.utils.delete', [
                                                    'url' => url('kodeakun', $kodeakun->kode_akun),
                                                ])
                                        ...
                                        @foreach ($list_kodeakun as $kodeakun)
                                            {{-- Modal Edit kodeakun --}}
                                            <div class="modal fade" id="editModal{{ $kodeakun->kode_akun }}" tabindex="-1"
                                                role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <form action="{{ url('kodeakun', $kodeakun->kode_akun) }}"
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="deskripsi" class="control-label">Deskripsi
                                                                    </label>
...
{{-- <script>
    ...
    $(document).ready(function() {
        $(".edit-button").click(function() {
            ...
            var id = dataTarget.replace("#edit", "{{ $kodeakun->id }}");
